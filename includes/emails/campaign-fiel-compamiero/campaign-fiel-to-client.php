        ...
        <!-- Header-->
          <tr>
              <td style="vertical-align: middle;">
                  ...
                  <img src="{base}img/email/email-fiel-companiero.jpg" style="margin:0; padding:0; border:none; display:block; width: 100%; height: auto;" border="0" alt="header" />
          ...
          <tr style="background-color: #4bc186;">
              <td style="padding: 10px; vertical-align: middle;">
                  ...
                  <h1 class="fallback-font" style="margin: 0px!important; font-family: 'Montserrat', sans-serif; font-size: 20px; color: #FFFFFF; text-align: center; font-weight: 700;">
                      <strong>Recibiste un pago por la {origin}</strong>
                  </h1>
          ...
          <tr style="background-color: #FFFFFF;">
              <td style="padding: 40px; text-align: center;">
                  ...
                  <p class="fallback-font" style="margin: 0 0 10px; font-family: 'Montserrat', sans-serif; font-size: 18px; line-height: 28px; color: #575756; text-align: left; font-weight: 400;">
                    Recibiste un nuevo pago por {origin}
                  </p>
                  <br>
                  <br>
                  ...
                  <p class="fallback-font" style="margin: 0 0 10px; font-family: 'Montserrat', sans-serif; font-size: 16px; line-height: 26px; color: #575756; text-align: left; font-weight: 400;">
                      <strong>DNI:</strong> {dni_number_user}
                  </p>

                  <p class="fallback-font" style="margin: 0 0 10px; font-family: 'Montserrat', sans-serif; font-size: 16px; line-height: 26px; color: #575756; text-align: left; font-weight: 400;">
                      <strong>CUIT:</strong> {cuit_user}
                  </p>
                  ...
                  <h3 class="fallback-font" style="margin: 0 0 10px 0; font-family: 'Montserrat', sans-serif; font-size: 16px; line-height: 26px; color: #575756; text-align: center; font-weight: 700;">
                      <strong>DATOS DEL PRODUCTO COMPRADO:</strong>
                  </h3>

                  <img width="150" src="{base}img/campaigns/fiel-companero/{path_category_product}/{image_product}" alt="imagen">

                  <p class="fallback-font" style="margin: 0 0 10px; font-family: 'Montserrat', sans-serif; font-size: 16px; line-height: 26px; color: #575756; text-align: left; font-weight: 400;">
                      <strong>SKU:</strong> {sku_product} <br>
                      <strong>CATEGORÍA:</strong> {category_product} <br>
                      <strong>VALOR:</strong> {value_product}
                  </p>

                  <hr>

                  <h3 class="fallback-font" style="margin: 0 0 10px 0; font-family: 'Montserrat', sans-serif; font-size: 16px; line-height: 26px; color: #575756; text-align: center; font-weight: 700;">
                      <strong>MEDIO DE PAGO 1:</strong>
                  </h3>
                  <p class="fallback-font" style="margin: 0 0 10px; font-family: 'Montserrat', sans-serif; font-size: 16px; line-height: 26px; color: #575756; text-align: left; font-weight: 400;">
                      <strong>NÚMERO DE OPERACIÓN:</strong> {payment_id_1} <br>
                      <strong>ESTADO:</strong> {payment_status_1} <br>
                      <strong>MEDIO DE PAGO:</strong> {payment_type_id_1} <br>
                      <strong>VALOR:</strong> {total_paid_amount_1} <br>
                  </p>

                  <h3 class="fallback-font" style="margin: 0 0 10px 0; font-family: 'Montserrat', sans-serif; font-size: 16px; line-height: 26px; color: #575756; text-align: center; font-weight: 700;">
                      <strong>MEDIO DE PAGO 2:</strong>
                  </h3>
                  <p class="fallback-font" style="margin: 0 0 10px; font-family: 'Montserrat', sans-serif; font-size: 16px; line-height: 26px; color: #575756; text-align: left; font-weight: 400;">
                      <strong>NÚMERO DE OPERACIÓN:</strong> {payment_id_2} <br>
                      <strong>ESTADO:</strong> {payment_status_2} <br>
                      <strong>MEDIO DE PAGO:</strong> {payment_type_id_2} <br>
                      <strong>VALOR:</strong> {total_paid_amount_2} <br>
                  </p>
          ...
          <tr align="center" style="background-color: #FFFFFF;">
              <td align="center"  style="background-color: #FFFFFF;padding: 10px;">
                ...
                <a target="_blank" rel="noopener noreferrer" href="{facebook}">
                  <img src="{base}landing/img/facebook.png" style="margin:0; margin-right: 20px; padding:0; border:none; display:inline-block; width: 16px; height: auto;" border="0" alt="facebook" />
                </a>

                <a target="_blank" rel="noopener noreferrer" href="{instagram}">
                  <img src="{base}landing/img/instagram.png" style="margin:0; margin-right: 20px; padding:0; border:none; display:inline-block; width: 16px; height: auto;" border="0" alt="instagram" />
                </a>

                <a target="_blank" rel="noopener noreferrer" href="{youtube}">
                  <img src="{base}landing/img/youtube.png" style="margin:0; margin-right: 20px; padding:0; border:none; display:inline-block; width: 16px; height: auto;" border="0" alt="youtube" />
                </a>
