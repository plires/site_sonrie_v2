...
<head>
  ...
  <meta name="description" content="Esperamos tu pago. Nuestro más importante logro en estos años de investigación fue la creación del PROGRAMA Rinascere">
  <title>Pago pendiente - Fundación Sonrie la Vida</title>
      ...
      <div class="container payment">
        ...
        <div class="row">
          ...
          <div class="col-md-12 p-0">
            ...
            <h2>Hubo un error al completar tu pago, o aún no se acreditó el mismo.</h2>

            <p class="parrafo">
              Por favor ponete en <a class="transition link" href="<?= BASE . 'contacto.php' ?>">contacto</a> con nosotros para poder ayudarte 
            </p>
